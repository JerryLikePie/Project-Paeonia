...
### 0.0.40
- 新增单位：研驱1式
- 不同空军种类有了自己的索敌机制，空军种类分为：Fighter, Attacker, Bomber
- 空军代码大幅优化，新增多种技能：
- - 研驱1：对地，制空
- - 研轰3：轰炸
- - 复兴甲：支援，侦查，制空
- 新增三个TR关卡来测试空军（无法通关，仅做测试）
- 敌方新增2个单位：气球靶机，轻型战斗机
- 新增敌方空军的特殊索敌
- 新增空军的地面标识，垂直指向地面的线条，便于辨认场上的空中单位
- 优化了空军的各种音效
- 编队页面现在可以通过点击技能按钮查看不同技能的表述
- 优化编队->DOLLS详情页面
- 修复了几个小bug

### 0.0.30
 - 商店页面增加，石油，合金等增减移动到商店页面
 - 主界面左侧的设置里面增加了清除剧情和关卡相关缓存
 - 新增三个教程关卡，包括里面的教程
 - 新增功能：播放剧情时替换BGM，并优化了剧情播放器
 - 新增地图页面完成一个区域后的引导（指向下一个区域）
 - 0.0.32：修复了击杀敌人使得目标消失时还未射出的炮弹会进入寻找敌人的无限循环导致Stack Overflow而闪退的bug；优化了菜单和UI逻辑，新增了“全解锁”选项

### 0.0.20
 - 我们不得不承认，从步入0.0.16版本以来九个月的战斗系统重构是一场彻底的灾难性失败。诚然，在这九个月内，经过我们的努力，完成了等高线地形图转游戏地图，主页UI重构，全局音量调整，经济和资源系统，背包系统，以及可探索的大地图，全新的战斗系统的论证等。然而，当我们我们推倒了原先的大厦，尝试实装新的战斗系统时，技术力和资源的限制让我们惊恐地发现我们并没有能力去建一个新的，完善的，可运行的游戏。过去九个月所完成的事务无非是在已经倒塌的废墟周围建造一个好看而不中用的花园罢了。
 - 当回过头来反省时，我发现对市面上的手游进行不切实际的模仿，对仍在学习阶段的我们的技术上的过高要求，以及为了变得更好而频繁变更重构的游戏逻辑设计，特别是最后一项导致的不断内耗，对我们的项目进度造成了深刻的伤害。思想不牢固，技术不过关，没有坚定地选择一条道路走下去，而是不断地推翻自己。同时我的主业：学业，也无法让我有足够的时间及时发现我的问题。在此情形下，我们决定回退到2022年1月，即0.0.15版本的进度，从那里继续我们的工作。在这里对所有在过去一年半中愿意支持我们的人们说一声对不起。
 - 鉴于新剧情的不确定性，和时间关系，我们的剧情设定将沿用火山中心的进度，而游戏性上将放弃0.0.16版本以来推崇的大地图，回到0.0.15版本的线性小关卡设计而不再改变。当然，这9个月以来已经完成的一些新功能，我们正在看可以怎么利用它们。
 - 战斗系统回退至了0.0.156版本
 - 摄像机不会潜到地底了，但是有可能会出现声音突然拉近的情况
 - 图鉴新增研驱-1
 - 新增音效（包括：引擎声，开火音效，击中音效等）全局控制
 - 暂且开放1-1一个关卡进行测试
 - 出击耗费10点油料，油料不足时无法进入战斗
 - 0.0.211：新增剧情演出系统
 - 0.0.22：全新的战斗BGM，分为平静和遇敌两个版本，可以做到无缝切换
 - 0.0.23：修复了几个让游戏持续崩溃的BUG
 - 0.0.24：更新了编队界面
...
### 0.0.16
 ...
 - 0.0.162：规避版权而使用新字体。等高线地形图作为战斗选择界面
 - 0.0.163：增加了屏幕的触摸音效，加入了试车场的地图
 - 0.0.166：加入了全新的经济系统和资源

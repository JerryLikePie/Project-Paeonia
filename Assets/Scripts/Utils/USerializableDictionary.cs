...
public class USerializableDictionary { }

[Serializable]
public class USerializableDictionary<TKey, TValue> :
    USerializableDictionary,
    ...
    IDictionary<TKey, TValue>
{
    ...
    public USerializableDictionary()
    {
...
//[CustomPropertyDrawer(typeof(USerializableDictionary), true)]
